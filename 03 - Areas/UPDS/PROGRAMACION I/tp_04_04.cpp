...
void calcular_estadisticas(vector<int>& notas, double& media, int& mayor, int& menor, vector<string>& nombres, vector<string>& apellidos, vector<string>& contrasenas);
...
int main() {
	...
	do {
		...
		case '2':
			...
			cout << "Se han llenado los nombres y apellidos para llenar las contraseñas.\n";
			break;
		case '3':
			// Sacar el promedio, el mayor y el menor de todas las notas con los nombres, apellidos y contraseña
			calcular_estadisticas(notas, media, mayor, menor, nombres, apellidos, contrasenas);
			break;
		case '4':
			// Imprimir datos
...
// Función para calcular el promedio, el mayor y el menor de todas las notas con los nombres, apellidos y contraseña
void calcular_estadisticas(vector<int>& notas, double& media, int& mayor, int& menor, vector<string>& nombres, vector<string>& apellidos, vector<string>& contrasenas) {
	...
	// Calcular el promedio como la suma dividida por el tamaño del vector
	media =(mayor + menor)/2.0; 
	
	// Imprimir el promedio, el mayor y el menor con los nombres, apellidos y contraseña
	cout << "El promedio de las notas es " << media << ".\n";
	cout<<"nombre\tapellidos\tnota\tcontrasela\n";
