...
namespace CapaDatos
{
    public class DbConnection
    {
        ...
        private readonly string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Sistema_Veterinario;Integrated Security=True;TrustServerCertificate=True;Connection Timeout=30;";
        /// <summary>
        /// (localdb)\MSSQLLocalDB
        /// DESKTOP-DCKO72L\\SQLEXPRESS
