-- ====================================================================
-- MIGRACIÓN: Gestión de Roles para Administrador
-- Fecha: 2025-09-02
...
-- --------------------------------------------------------
-- Actualizar tabla users para bloqueo/desbloqueo
-- --------------------------------------------------------
...
ALTER TABLE `users` 
ADD CONSTRAINT `fk_users_bloqueado_por` FOREIGN KEY (`bloqueado_por`) REFERENCES `users`(`id`) ON DELETE SET NULL;
...
-- 1. Conectarse a la base de datos tech_home
