...
<head>
    ...
    <title><?php echo $lang['app_name']; ?> - <?php echo $lang['transactions_by_date']; ?></title>
...
<body>
    <div id="reporte-transacciones-print">
    ...
    <div class="no-print" style="margin-top: 20px; text-align: center;">
        <button onclick="imprimirDocumento('reporte-transacciones-print', '<?php echo $lang['app_name'] . ' - ' . $lang['transactions_by_date']; ?>')" class="btn btn-primary"><?php echo $lang['print']; ?></button>
