...
namespace PedidosApp
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void btnPedidos_Click(object sender, EventArgs e)
        {
            ...
            var frmOrders = FrmOrders.GetInstancia();
            frmOrders.Usuario_id = this.Iduser;
            frmOrders.Nombre = this.Nombre;
        ...
        private void BtnReportes_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new FrmReportesAvanzados());
        }
        ...
        private void VistaClientesOrdens_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.Color7);
            OpenChildForm(new FrmVistaCliente_Orden());
        }

        private void btnReportes_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.Color1);
            OpenChildForm(new FrmReporteFactura());
        }
