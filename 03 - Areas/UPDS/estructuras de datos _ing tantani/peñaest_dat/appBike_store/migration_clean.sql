-- Script de migración simplificado para bike_store
-- Este script evita problemas de tablespace y hace una migración limpia
...
-- Vista para productos con ventas
...
SELECT 'Base de datos bike_store migrada exitosamente!' as mensaje;
SELECT COUNT(*) as total_tablas FROM information_schema.tables WHERE table_schema = 'bike_store';
SELECT 'Usuario admin creado - Contraseña: admin123' as credenciales;